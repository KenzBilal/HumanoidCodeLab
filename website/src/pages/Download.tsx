        ...
        <div style={{
          ...
          <ScrollReveal>
            <DownloadCard 
              ...
              format=".AppImage" 
              recommended={true}
              url="https://github.com/KenzBilal/HumanoidCodeLab/releases/download/v1.0.0/Humanoid-Code-Lab-1.0.0.AppImage"
          ...
          <ScrollReveal>
            <DownloadCard 
              os="Windows" 
              format=".exe" 
              url="https://github.com/KenzBilal/HumanoidCodeLab/releases/download/v1.0.0/Humanoid-Code-Lab-Setup-1.0.0.exe"
          ...
          <ScrollReveal>
            <DownloadCard 
              os="macOS" 
              format=".dmg" 
              url="https://github.com/KenzBilal/HumanoidCodeLab/releases/download/v1.0.0/Humanoid-Code-Lab-1.0.0.dmg"
